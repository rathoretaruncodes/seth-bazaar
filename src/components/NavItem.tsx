    ...
    return <div className='flex'>
        <div className='relative flex items-center'>
            <Button className='gap-1.5' onClick={handleOpen} variant={isOpen ? "secondary":"ghost"}>
                {category.label}
                {/* ChevronDown Icon with conditional class as an object: -rotate-180: isOpen  */}
                            ...
                            <div className='col-span-4 col-start-1 grid grid-cols-2 gap-x-8'>
                                {category.featured.map((item) => (
                                    ...
                                    className='group relative text-base sm:text-sm'>
                                     ...
                                     {/* aria-hidden:true keeps it hidden for a person reading using a screen reader */}
