...
const perks = [
  {
    ...
    description: "Get your assets delivered to your email in seconds and download them right now",
  },
  {
    name: "Guaranteed Quality",
    Icon: CheckCircle,
    description: "Every asset on our platform is verified by our team to ensure our hightest quality standards. Not happy? We offer a 10-day refund guarantee.",
  },
  {
    name: "For the planet",
    Icon: Leaf,
    description: "We've pledged 2% of sales to the preservation and restoration of the natural environment",
  },
]
